...
export type ResourceDocument = Document & Record<string, unknown>;
...
function getModel(name: string, schema: typeof userSchema): Model<ResourceDocument> {
  return (mongoose.models[name] as Model<ResourceDocument> | undefined) ||
    mongoose.model<ResourceDocument>(name, schema);
}
